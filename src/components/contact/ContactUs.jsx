        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">073971000</span>

              <a href="https://api.whatsapp.com/send?phone=51123456789&text=Hello, more information!" target="_blank" className="contact__button">
                Write me <i className="bx bx-right-arrow-alt contact__button-icon "></i>
              </a>
            </div>
        ...
        <div className="contact__content">
          ...
          <form action="" className="contact__form">
            ...
            <div className="contact__form-div contact__form-area">
              ...
              <textarea name="" placeholder="Write your project" id="" cols="30" rows="10" className="contact__form-input"></textarea>
            </div>
